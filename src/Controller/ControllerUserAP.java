 ...
 * @author patri
 */
public class ControllerUserAP {
   
    public ControllerUserAP(manage_user frmManageUser){
    ...
    public void search()
    {
        ...
        lstUsr = iUser.getAllByName(frmManageUser.gettxtCariNama().getText());
        TabelModelManageUser tableManageUser = new TabelModelManageUser(lstUsr);
        frmManageUser.getTabelData().setModel(tableManageUser);
    }
